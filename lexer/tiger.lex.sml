...
fun yyAction2 (strm, lastMatch : yymatch) = (yystrm := strm;
      (level := 1; YYBEGIN COMMENT; continue()))
fun yyAction3 (strm, lastMatch : yymatch) = (yystrm := strm;
      (level := !level + 1; continue()))
fun yyAction4 (strm, lastMatch : yymatch) = (yystrm := strm;
      (level := !level - 1; if !level = 0 then YYBEGIN INITIAL else (); continue()))
fun yyAction5 (strm, lastMatch : yymatch) = (yystrm := strm; (continue()))
fun yyAction6 (strm, lastMatch : yymatch) = (yystrm := strm;
      (currStr := ""; YYBEGIN STRING; continue()))
fun yyAction7 (strm, lastMatch : yymatch) = (yystrm := strm;
      (YYBEGIN INITIAL; Tokens.STRING(!currStr,yypos,yypos+1)))
fun yyAction8 (strm, lastMatch : yymatch) = (yystrm := strm;
      (currStr := !currStr ^ "\n"; continue()))
fun yyAction9 (strm, lastMatch : yymatch) = (yystrm := strm;
      (currStr := !currStr ^ "\t"; continue()))
...
fun yyAction12 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (currStr := !currStr ^ String.str(Char.chr(valOf(Int.fromString(String.substring(yytext,1,3))))); continue())
      end
...
fun yyAction15 (strm, lastMatch : yymatch) = let
      ...
      in
        yystrm := strm;
        (ErrorMsg.error yypos ("illegal use of escape character " ^ yytext); continue())
      end
fun yyAction16 (strm, lastMatch : yymatch) = (yystrm := strm;
      (ErrorMsg.error yypos ("illegal string: missing end quote"); continue()))
fun yyAction17 (strm, lastMatch : yymatch) = let
      val yytext = yymktext(strm)
      in
        yystrm := strm; (currStr := !currStr ^ yytext; continue())
      end
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction35(strm, yyNO_MATCH)
                      else yyQ62(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction35(strm, yyNO_MATCH)
                  else yyQ62(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction35(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction35(strm, yyNO_MATCH)
                  else yyQ67(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ62(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
              else yyAction35(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction35(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction35(strm, yyNO_MATCH)
                  else yyQ95(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ62(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
              else yyAction35(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction35(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction35(strm, yyNO_MATCH)
                  else yyQ99(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ62(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
              else yyAction35(strm, yyNO_MATCH)
      (* end case *))
...
fun yyQ105 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction60(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ105(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
            else if inp < #"0"
